...
export default function CategoryCard({ category }: CategoryProps) {
  return (
    <Link href={"/Shop"}>
      <div className="group category-card-enter flex cursor-pointer flex-col items-center gap-3 rounded-2xl border border-slate-100 bg-white/60 p-3 transition-all duration-300 hover:border-blue-200 hover:bg-blue-50/50 hover:shadow-md hover:shadow-blue-500/10">

...
import { Award, ChevronRight, Sparkles, Truck, ShieldCheck, Package } from "lucide-react";
...
export default function BrandsHero({ brandCount }: BrandsHeroProps) {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-100/90 bg-linear-to-br from-slate-50 via-white to-blue-50/60 px-5 py-8 shadow-sm shadow-slate-200/40 sm:px-8 sm:py-10 md:px-10 md:py-12">
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="font-bold text-slate-800">Brands</span>
        </nav>
        ...
        <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <div className="mt-4">
              <MyTitle tag="Shop by" name="Brand" />
            </div>
            <p className="mt-3 max-w-lg text-[15px] leading-relaxed text-slate-600">
              The same clean layout as Shop — trusted names, clear logos, and a
              layout built for browsing.
            </p>
          </div>
